            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (brokenAnim != null && brokenAnim.isStarted()) {
                       // Log.v("brokenView","onTouch 5 + " + brokenAnim.doReverse());
                        if(brokenAnim.doReverse())
                            Log.v("brokenView","onTouch 6");
